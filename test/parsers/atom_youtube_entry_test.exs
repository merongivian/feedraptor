defmodule Exfeed.Parser.AtomYoutubeEntryTest do
  ...
  test "should have the custom media url", %{entry: entry} do
    assert entry.media_url == "https://www.youtube.com/v/5shykyfmb28?version=3" # rubocop:disable Metrics/LineLength
  end
  ...
  test "should have the custom media thumbnail url", %{entry: entry} do
    assert entry.media_thumbnail_url == "https://i2.ytimg.com/vi/5shykyfmb28/hqdefault.jpg" # rubocop:disable Metrics/LineLength
  end
