defmodule Feedraptor.Parser.ItunesRSSTest do
  ...
  describe "can_parse/1" do
    test "returns true for an RSS feed" do
      assert Feedraptor.Parser.ItunesRSS.will_parse?(load_sample_itunes_feed())
    end

    test "returns false for an atom feed" do
      refute Feedraptor.Parser.ItunesRSS.will_parse?(load_sample_atom_feed())
    end

    test "returns false for an rss feedburner feed" do
      refute Feedraptor.Parser.ItunesRSS.will_parse?(load_sample_rss_feed_burner_feed())
    end
  end
